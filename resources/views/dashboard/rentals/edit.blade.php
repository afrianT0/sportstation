                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2bs4" id="item_id" name="item_id">
                                                    ...
                                                    @foreach ($items as $item)
                                                        @if ($item->stock > 0)
                                                            @if (old('item_id', $rental->item->id) == $item->id)
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('customer', $rental->customer) }}" required autofocus>
                                                @error('customer')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="dateRental" data-target-input="nearest">
                                                    <input type="text"
                                                        ...
                                                        id="date" name="date"
                                                        value="{{ old('date', $rental->date) }}" data-target="#dateRental"
                                                        required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="day" value="{{ old('day', $rental->day) }}" required>
                                                @error('day')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    id="price_day" name="price_day"
                                                    value="{{ old('price_day', $rental->price_day) }}" required readonly>
                                                @error('price_day')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    id="total" name="total"
                                                    value="{{ old('total', $rental->total) }}" required readonly>
                                                @error('total')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2bs4" id="payment" name="payment">
                                                    @foreach (['Cash', 'Transfer Bank', 'Credit Card'] as $option)
                                                        <option value="{{ $option }}"
                                                            {{ $rental->payment === $option || old('payment') === $option ? 'selected' : '' }}>
                                                            {{ $option }}
                                                        </option>
                                                    @endforeach
                                                </select>
