    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Data User <strong>{{ $title }}</strong></h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2bs4" id="roles" name="roles">
                                                    <option value="Admin" {{ $user->roles === 'Admin' ? 'selected' : '' }}>
                                                        Admin</option>
                                                    <option value="Kasir" {{ $user->roles === 'Kasir' ? 'selected' : '' }}>
                                                        Kasir</option>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    class="form-control @error('name') is-invalroles @enderror"
                                                    roles="name" name="name" value="{{ old('name', $user->name) }}"
                                                    required autofocus>
                                                @error('name')
