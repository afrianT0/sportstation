                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2bs4" id="category" name="category">
                                                    @foreach (['Soccer', 'Futsal', 'Badminton', 'Volley', 'Basketball'] as $option)
                                                        <option value="{{ $option }}"
                                                            {{ $item->category === $option || old('category') === $option ? 'selected' : '' }}>
                                                            {{ $option }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('price_item', $item->price_item) }}" required>
                                                @error('price_item')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('price_day', $item->price_day) }}" required>
                                                @error('price_day')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
